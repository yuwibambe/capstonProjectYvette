...
<html lang="en">
  <body>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('img/5.jpeg');" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
        <div class="row block-9">
          ...
          <div class="col-md-6 ftco-animate py-md-5">
            <form action="GoalModelServlet" method="post" class="contact-form">
            	<div class="row">
            		<div class="col-md-6">
